        ...
        return (
            <div className="bg-white dark:bg-black">
                ...
                <div className="flex m-5 justify-center gap-4">
                    <div className="border-2 border-gray-200 rounded-lg p-1 w-48 dark:border-gray-800 shadow-sm">
                    ...
                    {content.courses.length < 10 && (
                        <button
                            ...
                            dark:bg-gray-800 dark:hover:bg-gray-600 dark:hover:text-gray-300 transition-all duration-150 rounded-lg shadow-sm"
                            onClick={() => {
                                this.props.alert({
                                    title: 'Add a year?',
                                    message:
