...
function ContextMenuButton({ data, close }: ContextMenuButtonProps) {
  return (
    <button
      className="flex w-full items-center justify-end gap-4 px-4 py-2 text-gray-600 hover:bg-gray-100 hover:text-gray-800 active:bg-gray-200 active:text-gray-800
